...
namespace Cam.SmartContract
{
    public class StateMachine : StateReader
    {
        ...
        public StateMachine(Block persisting_block, DataCache<UInt160, AccountState> accounts, DataCache<ECPoint, ValidatorState> validators, DataCache<UInt256, AssetState> assets, DataCache<UInt160, ContractState> contracts, DataCache<StorageKey, StorageItem> storages)
        {
            ...
            Register("Cam.Account.SetVotes", Account_SetVotes);
            Register("Cam.Validator.Register", Validator_Register);
            ...
            Register("Cam.Contract.GetStorageContext", Contract_GetStorageContext);
            Register("Cam.Contract.Destroy", Contract_Destroy);
            Register("Cam.Storage.Put", Storage_Put);
            Register("Cam.Storage.Delete", Storage_Delete);

...
namespace Cam.SmartContract
{
    public class StateReader : InteropService
    {
        ...
        public StateReader()
        {
            Register("Cam.Runtime.GetTrigger", Runtime_GetTrigger);
            Register("Cam.Runtime.CheckWitness", Runtime_CheckWitness);
            Register("Cam.Runtime.Notify", Runtime_Notify);
            Register("Cam.Runtime.Log", Runtime_Log);
            Register("Cam.Runtime.GetTime", Runtime_GetTime);
            Register("Cam.Blockchain.GetHeight", Blockchain_GetHeight);
            Register("Cam.Blockchain.GetHeader", Blockchain_GetHeader);
            Register("Cam.Blockchain.GetBlock", Blockchain_GetBlock);
            Register("Cam.Blockchain.GetTransaction", Blockchain_GetTransaction);
            Register("Cam.Blockchain.GetAccount", Blockchain_GetAccount);
            Register("Cam.Blockchain.GetValidators", Blockchain_GetValidators);
            Register("Cam.Blockchain.GetAsset", Blockchain_GetAsset);
            Register("Cam.Blockchain.GetContract", Blockchain_GetContract);
            Register("Cam.Header.GetIndex", Header_GetIndex);
            Register("Cam.Header.GetHash", Header_GetHash);
            Register("Cam.Header.GetVersion", Header_GetVersion);
            Register("Cam.Header.GetPrevHash", Header_GetPrevHash);
            Register("Cam.Header.GetMerkleRoot", Header_GetMerkleRoot);
            Register("Cam.Header.GetTimestamp", Header_GetTimestamp);
            Register("Cam.Header.GetConsensusData", Header_GetConsensusData);
            Register("Cam.Header.GetNextConsensus", Header_GetNextConsensus);
            Register("Cam.Block.GetTransactionCount", Block_GetTransactionCount);
            Register("Cam.Block.GetTransactions", Block_GetTransactions);
            Register("Cam.Block.GetTransaction", Block_GetTransaction);
            Register("Cam.Transaction.GetHash", Transaction_GetHash);
            Register("Cam.Transaction.GetType", Transaction_GetType);
            Register("Cam.Transaction.GetAttributes", Transaction_GetAttributes);
            Register("Cam.Transaction.GetInputs", Transaction_GetInputs);
            Register("Cam.Transaction.GetOutputs", Transaction_GetOutputs);
            Register("Cam.Transaction.GetReferences", Transaction_GetReferences);
            Register("Cam.Transaction.GetUnspentCoins", Transaction_GetUnspentCoins);
            Register("Cam.Attribute.GetUsage", Attribute_GetUsage);
            Register("Cam.Attribute.GetData", Attribute_GetData);
            Register("Cam.Input.GetHash", Input_GetHash);
            Register("Cam.Input.GetIndex", Input_GetIndex);
            Register("Cam.Output.GetAssetId", Output_GetAssetId);
            Register("Cam.Output.GetValue", Output_GetValue);
            Register("Cam.Output.GetScriptHash", Output_GetScriptHash);
            Register("Cam.Account.GetScriptHash", Account_GetScriptHash);
            Register("Cam.Account.GetVotes", Account_GetVotes);
            Register("Cam.Account.GetBalance", Account_GetBalance);
            Register("Cam.Asset.GetAssetId", Asset_GetAssetId);
            Register("Cam.Asset.GetAssetType", Asset_GetAssetType);
            Register("Cam.Asset.GetAmount", Asset_GetAmount);
            Register("Cam.Asset.GetAvailable", Asset_GetAvailable);
            Register("Cam.Asset.GetPrecision", Asset_GetPrecision);
            Register("Cam.Asset.GetOwner", Asset_GetOwner);
            Register("Cam.Asset.GetAdmin", Asset_GetAdmin);
            Register("Cam.Asset.GetIssuer", Asset_GetIssuer);
            Register("Cam.Contract.GetScript", Contract_GetScript);
            Register("Cam.Storage.GetContext", Storage_GetContext);
            Register("Cam.Storage.Get", Storage_Get);

...
{
    public class CamService : StandardService
    {
        public CamService(TriggerType trigger, Snapshot snapshot)
            : base(trigger, snapshot)
        {
            Register("Cam.Runtime.GetTrigger", Runtime_GetTrigger, 1);
            Register("Cam.Runtime.CheckWitness", Runtime_CheckWitness, 200);
            Register("Cam.Runtime.Notify", Runtime_Notify, 1);
            Register("Cam.Runtime.Log", Runtime_Log, 1);
            Register("Cam.Runtime.GetTime", Runtime_GetTime, 1);
            Register("Cam.Runtime.Serialize", Runtime_Serialize, 1);
            Register("Cam.Runtime.Deserialize", Runtime_Deserialize, 1);
            Register("Cam.Blockchain.GetHeight", Blockchain_GetHeight, 1);
            Register("Cam.Blockchain.GetHeader", Blockchain_GetHeader, 100);
            Register("Cam.Blockchain.GetBlock", Blockchain_GetBlock, 200);
            Register("Cam.Blockchain.GetTransaction", Blockchain_GetTransaction, 100);
            Register("Cam.Blockchain.GetTransactionHeight", Blockchain_GetTransactionHeight, 100);
            Register("Cam.Blockchain.GetAccount", Blockchain_GetAccount, 100);
            Register("Cam.Blockchain.GetValidators", Blockchain_GetValidators, 200);
            Register("Cam.Blockchain.GetAsset", Blockchain_GetAsset, 100);
            Register("Cam.Blockchain.GetContract", Blockchain_GetContract, 100);
            Register("Cam.Header.GetHash", Header_GetHash, 1);
            Register("Cam.Header.GetVersion", Header_GetVersion, 1);
            Register("Cam.Header.GetPrevHash", Header_GetPrevHash, 1);
            Register("Cam.Header.GetMerkleRoot", Header_GetMerkleRoot, 1);
            Register("Cam.Header.GetTimestamp", Header_GetTimestamp, 1);
            Register("Cam.Header.GetIndex", Header_GetIndex, 1);
            Register("Cam.Header.GetConsensusData", Header_GetConsensusData, 1);
            Register("Cam.Header.GetNextConsensus", Header_GetNextConsensus, 1);
            Register("Cam.Block.GetTransactionCount", Block_GetTransactionCount, 1);
            Register("Cam.Block.GetTransactions", Block_GetTransactions, 1);
            Register("Cam.Block.GetTransaction", Block_GetTransaction, 1);
            Register("Cam.Transaction.GetHash", Transaction_GetHash, 1);
            Register("Cam.Transaction.GetType", Transaction_GetType, 1);
            Register("Cam.Transaction.GetAttributes", Transaction_GetAttributes, 1);
            Register("Cam.Transaction.GetInputs", Transaction_GetInputs, 1);
            Register("Cam.Transaction.GetOutputs", Transaction_GetOutputs, 1);
            Register("Cam.Transaction.GetReferences", Transaction_GetReferences, 200);
            Register("Cam.Transaction.GetUnspentCoins", Transaction_GetUnspentCoins, 200);
            Register("Cam.Transaction.GetWitnesses", Transaction_GetWitnesses, 200);
            Register("Cam.InvocationTransaction.GetScript", InvocationTransaction_GetScript, 1);
            Register("Cam.Witness.GetVerificationScript", Witness_GetVerificationScript, 100);
            Register("Cam.Attribute.GetUsage", Attribute_GetUsage, 1);
            Register("Cam.Attribute.GetData", Attribute_GetData, 1);
            Register("Cam.Input.GetHash", Input_GetHash, 1);
            Register("Cam.Input.GetIndex", Input_GetIndex, 1);
            Register("Cam.Output.GetAssetId", Output_GetAssetId, 1);
            Register("Cam.Output.GetValue", Output_GetValue, 1);
            Register("Cam.Output.GetScriptHash", Output_GetScriptHash, 1);
            Register("Cam.Account.GetScriptHash", Account_GetScriptHash, 1);
            Register("Cam.Account.GetVotes", Account_GetVotes, 1);
            Register("Cam.Account.GetBalance", Account_GetBalance, 1);
            Register("Cam.Account.IsStandard", Account_IsStandard, 100);
            Register("Cam.Asset.Create", Asset_Create);
            Register("Cam.Asset.Renew", Asset_Renew);
            Register("Cam.Asset.GetAssetId", Asset_GetAssetId, 1);
            Register("Cam.Asset.GetAssetType", Asset_GetAssetType, 1);
            Register("Cam.Asset.GetAmount", Asset_GetAmount, 1);
            Register("Cam.Asset.GetAvailable", Asset_GetAvailable, 1);
            Register("Cam.Asset.GetPrecision", Asset_GetPrecision, 1);
            Register("Cam.Asset.GetOwner", Asset_GetOwner, 1);
            Register("Cam.Asset.GetAdmin", Asset_GetAdmin, 1);
            Register("Cam.Asset.GetIssuer", Asset_GetIssuer, 1);
            Register("Cam.Contract.Create", Contract_Create);
            Register("Cam.Contract.Migrate", Contract_Migrate);
            Register("Cam.Contract.Destroy", Contract_Destroy, 1);
            Register("Cam.Contract.GetScript", Contract_GetScript, 1);
            Register("Cam.Contract.IsPayable", Contract_IsPayable, 1);
            Register("Cam.Contract.GetStorageContext", Contract_GetStorageContext, 1);
            Register("Cam.Storage.GetContext", Storage_GetContext, 1);
            Register("Cam.Storage.GetReadOnlyContext", Storage_GetReadOnlyContext, 1);
            Register("Cam.Storage.Get", Storage_Get, 100);
            Register("Cam.Storage.Put", Storage_Put);
            Register("Cam.Storage.Delete", Storage_Delete, 100);
            Register("Cam.Storage.Find", Storage_Find, 1);
            Register("Cam.StorageContext.AsReadOnly", StorageContext_AsReadOnly, 1);
            Register("Cam.Enumerator.Create", Enumerator_Create, 1);
            Register("Cam.Enumerator.Next", Enumerator_Next, 1);
            Register("Cam.Enumerator.Value", Enumerator_Value, 1);
            Register("Cam.Enumerator.Concat", Enumerator_Concat, 1);
            Register("Cam.Iterator.Create", Iterator_Create, 1);
            Register("Cam.Iterator.Key", Iterator_Key, 1);
            Register("Cam.Iterator.Keys", Iterator_Keys, 1);
            Register("Cam.Iterator.Values", Iterator_Values, 1);
            Register("Cam.Iterator.Concat", Iterator_Concat, 1);

            #region Aliases
            Register("Cam.Iterator.Next", Enumerator_Next, 1);
            Register("Cam.Iterator.Value", Enumerator_Value, 1);
            #endregion
